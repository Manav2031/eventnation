    ...
    const handleSignup = async (e) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5000/auth/signup', {
                ...
                body: JSON.stringify({ username, email, password ,phone,full_name}),
            });
